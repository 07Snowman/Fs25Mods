...
mods_folder = os.path.expanduser(r"~\Documents\My Games\FarmingSimulator2025\Mods")
    ...
    for root, _, files in os.walk(source_folder):  # Walk through all subdirectories
        for filename in files:
            ...
            if filename.endswith(".zip"):
                if not os.path.exists(destination_path) or os.path.getmtime(str(source_path)) > os.path.getmtime(
